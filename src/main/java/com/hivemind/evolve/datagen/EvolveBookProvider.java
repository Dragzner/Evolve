...
public class EvolveBookProvider extends BookProvider {

    public EvolveBookProvider(DataGenerator generator, String modid, LanguageProvider lang) {
    ...
    protected void generate() {
        ...
        var geneCodex = this.makeGeneCodex("geneCodex");

        //then add the book to the list of books to generate
        this.add(geneCodex);
    }

    private BookModel makeGeneCodex(String bookName) {
        ...
        var demoBook = BookModel.builder()
                ...
                .withCreativeTab("evolve_tab") //and put it in the modonomicon tab
